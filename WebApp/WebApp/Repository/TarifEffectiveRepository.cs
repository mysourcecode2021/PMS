...
{
    public class TarifEffectiveRepository : DapperContext
    {
        public async Task<PagingModel<List<dynamic>>> GetDataPaging(dynamic param)
        {
            ...
            var data = await this.GetListPagingAsync<dynamic>("sp_TarifEffective_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> GetDataByKey(dynamic param)
        {
            ...
            var data = await this.GetListAsync<dynamic>("sp_TarifEffective_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> SaveProcess(dynamic param, string userId)
        {
            ...
            {
                par.Add("@Id", (d.Id.ToString() == "") ? null : d.Id.ToString());
                par.Add("@TarifId", d.TarifId.ToString());
                par.Add("@AmountFrom", d.AmountFrom.ToString());
                par.Add("@AmountTo", d.AmountTo.ToString());
                par.Add("@Rate", d.Rate.ToString());
                par.Add("@UserId", userId);
            }
            par.Add("@Action", d.Action.ToString());

            var data = await this.GetListAsync<dynamic>("sp_TarifEffective_Process", par, "SP");
            return data;
        }
    }
}
