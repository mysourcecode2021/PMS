...
{
    public class CalendarRepository : DapperContext
    {
        public async Task<PagingModel<List<dynamic>>> GetDataPaging(dynamic param)
        {
            ...
            var data = await this.GetListPagingAsync<dynamic>("sp_Calendar_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> GetDataByKey(dynamic param)
        {
            ...
            var data = await this.GetListAsync<dynamic>("sp_Calendar_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> SaveProcess(dynamic param, string userId)
        {
            ...
            {
                par.Add("@DateInput", d.DateInput.ToString());
                par.Add("@Category", d.Category.ToString());
                par.Add("@Description", d.Description.ToString());
                par.Add("@UserId", userId);
            }
            par.Add("@Action", d.Action.ToString());

            var data = await this.GetListAsync<dynamic>("sp_Calendar_Process", par, "SP");
            return data;
        }
    }
}
