...
{
    public class DepartmentRepository : DapperContext
    {
        public async Task<PagingModel<List<dynamic>>> GetDataPaging(dynamic param)
        {
            ...
            var data = await this.GetListPagingAsync<dynamic>("sp_Department_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> GetDataByKey(dynamic param)
        {
            ...
            var data = await this.GetListAsync<dynamic>("sp_Department_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> SaveProcess(dynamic param, string userId)
        {
            ...
            else
            {
                ...
                par.Add("@DepartmentName", d.DepartmentName.ToString());
                par.Add("@UserId", userId);
            }
            par.Add("@Action", d.Action.ToString());

            var data = await this.GetListAsync<dynamic>("sp_Department_Process", par, "SP");
            return data;
        }
    }
}
