...
{
    public class MappingBonusRateRepository : DapperContext
    {
        public async Task<PagingModel<List<dynamic>>> GetDataPaging(dynamic param)
        {
            ...
            var data = await this.GetListPagingAsync<dynamic>("sp_MappingBonusRate_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> GetDataByKey(dynamic param)
        {
            ...
            var data = await this.GetListAsync<dynamic>("sp_MappingBonusRate_Get", par, "SP");
            return data;
        }
        ...
        public async Task<List<dynamic>> SaveProcess(dynamic param, string userId)
        {
            ...
            var data = await this.GetListAsync<dynamic>("sp_MappingBonusRate_Process", par, "SP");
            return data;
        }
    }
}
