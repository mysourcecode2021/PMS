...
{
    public class BonusRateController : Controller
    {
        BonusRateRepository _repo = new BonusRateRepository();
        ...
        public async Task<IActionResult> ExportExcel([FromBody] dynamic param)
        {
            ...
            byte[] result = util.ExportListtoExcel<dynamic>(data, "Data", "Bonus Rate");
