...
{
    public class ReportBPJSTKController : Controller
    {
        ...
        public async Task<IActionResult> ExportExcel([FromBody] dynamic param)
        {
            ...
            byte[] result = util.ExportListtoExcel<dynamic>(data, "Data", "Report BPJS Employment", d.ParamHeader.ToString().Replace(";", ""), "BPJSTK");
